...
<body>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasFavourites" aria-labelledby="Favourites">
        <div class="offcanvas-header justify-content-center">
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <div id="favourites-content">
                <p class="text-center py-4">Loading favourites...</p>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas-body">
            <div class="order-md-last">
                ...
                @if (session()->has('cart') && count(session('cart')) > 0)
                    ...
                    <a href="{{ route('checkout.show') }}" class="w-100 btn btn-warning btn-lg text-uppercase">
                        {{ __('continue_to_checkout') }}
                    </a>
                @else
                ...
                <div
                    ...
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        ...
                        <li>
                            <a href="#" class="position-relative" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvasFavourites">
                                <svg width="24" height="24">
                                    <use xlink:href="#heart"></use>
                                </svg>
                                <span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger fav-count">
                    ...
                    <div class="dropdown d-inline-block ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="langDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ route('lang.switch', 'hi') }}">हिन्दी</a></li>
                    ...
                    <div class="cart text-end d-none d-lg-block dropdown">
                        <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button"
                            ...
                            <span class="fs-6 text-muted dropdown-toggle">{{ __('cart') }}</span>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <ul
                                    ...
                                    <li class="nav-item active">
                                        <a href="#women" class="nav-link">{{ __('women') }}</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a href="#men" class="nav-link">{{ __('men') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#kids" class="nav-link">{{ __('kids') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#accessories" class="nav-link">{{ __('accessories') }}</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" role="button" id="pages"
                                            data-bs-toggle="dropdown" aria-expanded="false">{{ __('pages') }}</a>
                                        <ul class="dropdown-menu" aria-labelledby="pages">
                                            <li><a href="index.html" class="dropdown-item">{{ __('about_us') }} </a>
                                            </li>
                                            <li><a href="index.html" class="dropdown-item">Shop </a></li>
                                            <li><a href="index.html" class="dropdown-item">Single Product </a></li>
                                            <li><a href="index.html" class="dropdown-item">{{ __('cart') }} </a>
                                            </li>
                                            <li><a href="index.html" class="dropdown-item">Checkout </a></li>
                                            <li><a href="index.html" class="dropdown-item">{{ __('blog') }} </a>
                                            </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="#brand" class="nav-link">{{ __('brand') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sale" class="nav-link">{{ __('sale') }}</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <div class="container">
        @if (session()->has('error') || session()->has('success') || session()->has('cancel_message'))
            <div class="row mb-4">
                <div class="col-12">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title">{{ __('ultras') }}</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('about_us') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('conditions') }} </a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('our_journals') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('careers') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('affiliate_programme') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('ultras_press') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title">{{ __('customer_service') }}</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('privacy_policy') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('returns_refunds') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('cookie_guidelines') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link"></a>{{ __('delivery_information') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            ...
                            <li class="menu-item">
                                <a href="#" class="nav-link">{{ __('delivery_information') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title">{{ __('subscribe_us') }}</h5>
    ...
    <script>
        $(document).ready(function() {
            $('.add-to-cart').click(function(e) {
                ...
                var quantity = $(this).closest('.d-flex').find('input[name="quantity"]').val() || 1;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('.cart-total').text('₹' + parseFloat(response.cart_total || 0)
                            .toFixed(2));

                        $.get('{{ route('cart.html') }}', function(html) {
                            $('#offcanvasCart .offcanvas-body .order-md-last').html(
                                html);
                        });
                    },
                    error: function(xhr) {
                        console.log('Error:', xhr.status, xhr.responseText);
                        alert('Error: ' + (xhr.responseJSON?.message || 'Failed to add item'));
                    }
                });
            });
        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            btn.toggleClass('active', response.isFavorited);

                            $('.fav-count').text(response.count);

                            $.get('{{ route('favourites.html') }}', function(html) {
                                $('#favourites-content').html(html);
                            });
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/699fe0044afa321c34c78bac/1jic864s9';
            s1.charset = 'UTF-8';
