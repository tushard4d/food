                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <form action="{{ route('subscription.checkout', $sub->id) }}" method="POST" class="mt-3">
                                    @csrf
                    ...
                    <div class="bootstrap-tabs product-tabs">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-all" role="tabpanel"
                                ...
                                <div
                                    id="product-list" class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="product-list" class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        @foreach ($products as $product)
                            <div class="col">
                                <div class="product-item">
